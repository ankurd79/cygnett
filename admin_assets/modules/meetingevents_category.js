//alert('hello');
						$("#shwdatatable").load(base_url+'manage-meeting-events/list');
							
						var res='meeting and events unit';
						$("#frmme_add,#frmme_edit").validate({
			                rules: {
			                    meeting_unit: {
			                        required: true,
			                        minlength: 3,
			...
			$("#frmme_add").on('submit',(function(e) {
				//alert('hello');
			        e.preventDefault();
			        if($("#frmme_add").valid()){
			            $.ajax({
			                ...
			                contentType: false,
			                processData: false,
			                url:base_url+'add-meeting-event-unit',
			                ...
			                //alert(data);
									...
									}else if(data=='Information already present!'){
									    
									    //jQuery("#redalert").show();
									    jQuery("#redalert").html(data);
									    $('html, body').animate({scrollTop: '0px'}, 300);
									    $("#meeting_unit").css("background-color", "#FA8072");
									    $(function() {	
										    ...
										    Toast.fire({
										        icon: 'error',
										        title: ' Information already present!'
	      									})
	      								});
									}
			...
			$("#frmme_edit").on('submit',(function(e) {
										//alert('hello');
									        e.preventDefault();
									        if($("#frmme_edit").valid()){
									            $.ajax({
									                ...
									                contentType: false,
									                processData: false,
									                url:base_url+'update-meeting-event-unit',
									                data:new FormData(this),
									                beforeSend: function ( xhr ) {
									                    //Add your image loader here
									                     jQuery(".lds-facebook").show();
            ...
            $(document).on('click', '.delete', function(){
                      ...
                      // AJAX Request
		                                       $.ajax({
		                                         ...
		                                         url: base_url+'api/meetingevents/meetingevents/remove',
		                                         type: 'POST',
		                                         data: { id:deleteid },
