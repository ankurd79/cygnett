				...
				<div class="col-md-12">
					<div class="card card-primary">
						<div class="card-header">
              			...
              			<form id='frmdesig_edit' name='frmdesig_edit' method='post' enctype="multipart/form-data" autocomplete="off">
			                <div class="card-body">
                  ...
                  <p class="mb-0"><i class="icon fas fa-ban"></i></p>
			                  ...
			                  <div class="form-group col-md-9">
			                    ...
			                    <input type="text" class="form-control" value="<?php echo $results[0]['designation'] ?>" name="designation" id="designation" placeholder="Designation">	
			                  </div>
                  ...
                  <p class="mb-0"><i class="icon fas fa-ban"></i></p>
			                ...
			                <input type='hidden' name='designation_id' id='designation_id' value='<?php echo base64_encode($results[0]['id']) ?>'>
              			</form>	
