        ...
        <table class="table">
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        <td><?php echo $i++ ?>.</td>
                        <td><?php echo $recs['news_title'] ?></td>
                        <td><?php echo $recs['source'] ?></td>
                        <td>
                        ...
                        <td><a href="<?php echo base_url() ?>manage-media-news/edit/<?php echo base64_encode($recs['id']) ?>"><i class="fas fa-edit"></i></a></td>
