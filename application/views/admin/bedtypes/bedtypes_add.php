        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><?php //echo $sub_title ?>Add Bed Types</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
				...
				<div class="col-md-12">
					<div class="card card-primary">
						<div class="card-header">
                			<h3 class="card-title"><?php //echo $sub_title ?>Add Bed Types</h3>
              			</div>

              			<form id='frmbedtype_add' name='frmbedtype_add' method='post' enctype="multipart/form-data" autocomplete="off">
			                <div class="card-body">
			                  ...
			                  <div class="form-group col-md-9">
			                    ...
			                    <input type="text" class="form-control" name="bed_type" id="bed_type" placeholder="Bed Type">	
			                  </div>
