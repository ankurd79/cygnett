        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><?php //echo $sub_title ?>Edit Bed Type</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
				...
				<div class="col-md-12">
					<div class="card card-primary">
						<div class="card-header">
                			<h3 class="card-title"><?php //echo $sub_title ?>Edit Bed Type</h3>
              			</div>

              			<form id='frmbedtype_edit' name='frmbedtype_edit' method='post' enctype="multipart/form-data" autocomplete="off">
			                <div class="card-body">
			                  ...
			                  <div class="form-group col-md-9">
			                    ...
			                    <input type="text" class="form-control" value="<?php echo $results[0]['bed_type'] ?>" name="bed_type" id="bed_type" placeholder="Bed Type">	
			                  </div>
                  ...
                  <p class="mb-0"><i class="icon fas fa-ban"></i></p>
			                ...
			                <input type='hidden' name='bed_type_id' id='bed_type_id' value='<?php echo base64_encode($results[0]['id']) ?>'>
              			</form>	
