...
<div class="content-wrapper">
	...
	<section class="content">
		<div class="container-fluid">
				...
				<div class="col-md-12">
					<div class="card card-primary">
						<div class="card-header">
              			...
              			<form id='frmnav_add' name='frmnav_add' method='post' enctype="multipart/form-data" autocomplete="off">
			                <div class="card-body">
                  ...
                  <p class="mb-0"><i class="icon fas fa-ban"></i></p>
			                  ...
			                  <div class="form-group col-md-9">
			                    ...
			                    <input type="text" class="form-control" name="page_category" id="page_category" placeholder="Hotel Navigation Category">	
			                  </div>
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Hotel Navigations</h3>
