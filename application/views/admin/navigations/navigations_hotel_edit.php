				...
				<div class="col-md-12">
					<div class="card card-primary">
						<div class="card-header">
              			...
              			<form id='frmnav_edit' name='frmnav_edit' method='post' enctype="multipart/form-data" autocomplete="off">
			                <div class="card-body">
                  ...
                  <p class="mb-0"><i class="icon fas fa-ban"></i></p>
			                  ...
			                  <div class="form-group col-md-9">
			                    <label for="exampleInputEmail1">Navigation Category</label>
			                    <input type="text" class="form-control" value='<?php echo $results[0]['page_category'] ?>' name="page_category" id="page_category" placeholder="Hotel Navigation Category">	
			                  </div>
