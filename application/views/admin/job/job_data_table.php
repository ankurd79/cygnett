        ...
        <table class="table">
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        <td><?php echo $i++ ?>.</td>
                        <td><?php echo $recs['job_title'] ?><br><a href='<?php echo base_url() ?>view-job-applications/list/<?php echo base64_encode($recs['id']) ?>' target='_blank'>View Applications</a></td>
                        <td><?php echo $recs['job_location'] ?></td>
                        <td>
                        ...
                        <td><a href="<?php echo base_url() ?>manage-job-posts/edit/<?php echo base64_encode($recs['id']) ?>"><i class="fas fa-edit"></i></a></td>
