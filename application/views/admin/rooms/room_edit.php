				...
				<div class="col-md-12">
					<div class="card card-primary">
						<div class="card-header">
              			...
              			<form id='frmroom_type_edit' name='frmroom_type_edit' method='post' enctype="multipart/form-data" autocomplete="off">
			                <div class="card-body">
			                  ...
			                  <div class="form-group col-md-9">
			                    ...
			                    <input type="text" class="form-control" value="<?php echo $results[0]['room_type'] ?>" name="room_type" id="room_type" placeholder="Room Type">	
			                  </div>
                  ...
                  <p class="mb-0"><i class="icon fas fa-ban"></i></p>
			                ...
			                <input type='hidden' name='room_type_id' id='room_type_id' value='<?php echo base64_encode($results[0]['id']) ?>'>
              			</form>	
