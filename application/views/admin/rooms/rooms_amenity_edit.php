				...
				<div class="col-md-12">
					<div class="card card-primary">
						<div class="card-header">
              			...
              			<form id='frmcat_edit' name='frmcat_edit' method='post' enctype="multipart/form-data" autocomplete="off">
			                <div class="card-body">
                  ...
                  <p class="mb-0"><i class="icon fas fa-ban"></i></p>
			                  ...
			                  <div class="form-group col-md-9">
			                    ...
			                    <input type="text" class="form-control" value='<?php echo $results[0]['category'] ?>' name="category" id="category" placeholder="Hotel Category">	
			                  </div>
                  ...
                  <p class="mb-0"><i class="icon fas fa-ban"></i></p>
			                ...
			                <input type='hidden' id='cat_id' name='cat_id' value='<?php echo base64_encode($results[0]['id'])?>'>
              			</form>	
