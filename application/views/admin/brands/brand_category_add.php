...
<div class="content-wrapper">
	...
	<section class="content">
		<div class="container-fluid">
				...
				<div class="col-md-12">
					<div class="card card-primary">
						<div class="card-header">
              			...
              			<form id='frmbrandcat_add' name='frmbrandcat_add' method='post' enctype="multipart/form-data" autocomplete="off">
			                <div class="card-body">
			                	
			                	
			                	<div class="form-row">
			                  <div class="form-group col-md-9">
			                    <label for="exampleInputEmail1">Add Brand Category (Eg: Upscale/Midscale..)</label>
			                    <input type="text" class="form-control" name="category" id="category" placeholder="Brand Category">	
			                  </div>
			              ...
			              <div class="form-group col-md-9">
			                    ...
			                    <textarea class="form-control" rows="6" name="text" id="text" placeholder="Intro Text"></textarea>
			                  </div>
			               </div>   
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Brand Category</h3>
