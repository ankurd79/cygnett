        ...
        <table class="table">
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        <td><?php echo $i++ ?>.</td>
                        <td><?php echo $recs['meeting_unit'] ?></td>
                        <td>
                        ...
                        <td><a href="<?php echo base_url() ?>manage-meeting-events/edit/<?php echo base64_encode($recs['id']) ?>"><i class="fas fa-edit"></i></a></td>
