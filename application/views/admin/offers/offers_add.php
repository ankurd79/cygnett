				...
				<div class="col-md-12">
					<div class="card card-primary">
						<div class="card-header">
              			...
              			<form id='frmoffr_add' name='frmoffr_add' method='post' enctype="multipart/form-data" autocomplete="off">
			                <div class="card-body">
                  ...
                  <p class="mb-0"><i class="icon fas fa-ban"></i></p>
			                  ...
			                  <div class="form-group col-md-6">
			                    ...
			                    <input type="text" class="form-control" name="offer_name" id="offer_name" placeholder="Offer name">	
			                  </div>
			              ...
			              <div class="form-row">
			                  ...
			                  <div class="form-group col-md-6">
			                   ...
			                   <textarea class="form-control" rows="6" name="short_intro" id="short_intro" placeholder="Short Intro"></textarea>
			                  </div>
