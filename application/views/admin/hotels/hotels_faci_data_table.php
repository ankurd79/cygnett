        ...
        <table class="table">
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        <td><?php echo $i++ ?>.</td>
                        <td><input type="text" value='<?php echo $recs['facility'] ?>' class="form-control" name="facility[]" id="facility_1" placeholder="Hotel Facility"></td>
                        <td>
                      ...
                      <input type='hidden' name='facility_id[]' value='<?php echo $recs['id'] ?>'>
                    <?php } }?> 
                  </tbody>
                </table>
