...
<div class="content-wrapper">
	...
	<section class="content">
		<div class="container-fluid">
				...
				<div class="col-md-12">
					<div class="card card-primary">
						<div class="card-header">
              			...
              			<form id='frmcat_add' name='frmcat_add' method='post' enctype="multipart/form-data" autocomplete="off">
			                <div class="card-body">
                  ...
                  <p class="mb-0"><i class="icon fas fa-ban"></i></p>
			                  ...
			                  <div class="form-group col-md-9">
			                    ...
			                    <input type="text" class="form-control" name="category" id="category" placeholder="Hotel Category">	
			                  </div>
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Hotel Categories</h3>
