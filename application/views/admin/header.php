...
<link rel="stylesheet" href="<?php echo base_url() ?><?php echo adm_assets ?>/plugins/sweetalert2-theme-bootstrap-4/bootstrap-4.min.css">
  ...
  <link rel="stylesheet" href="<?php echo base_url() ?><?php echo adm_assets ?>/plugins/datatables-bs4/css/dataTables.bootstrap4.min.css">
  <link rel="stylesheet" 
  href="<?php echo base_url() ?><?php echo adm_assets ?>/plugins/datatables-responsive/css/responsive.bootstrap4.min.css">
  <link rel="stylesheet" 
  href="<?php echo base_url() ?><?php echo adm_assets ?>/plugins/datatables-buttons/css/buttons.bootstrap4.min.css">
