        ...
        <table class="table">
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        <td><?php echo $i++ ?>.</td>
                        <td><?php echo $recs['first_name'] ?> <?php echo $recs['last_name'] ?></td>
                        <td><?php echo $recs['deptt_name'] ?></td>
                        <td>
                        ...
                        <td><a href="<?php echo base_url() ?>manage-team-members/edit/<?php echo base64_encode($recs['id']) ?>"><i class="fas fa-edit"></i></a></td>
