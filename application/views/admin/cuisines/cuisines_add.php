				...
				<div class="col-md-12">
					<div class="card card-primary">
						<div class="card-header">
              			...
              			<form id='frmcuisine_add' name='frmcuisine_add' method='post' enctype="multipart/form-data" autocomplete="off">
			                <div class="card-body">
			                	
			                	
			                	<div class="form-row">
			                  <div class="form-group col-md-9">
			                    <label for="exampleInputEmail1">Add Cuisine Name</label>
			                    <input type="text" class="form-control" name="cuisine_name" id="cuisine_name" placeholder="Add Cuisine Name">	
			                  </div>
