				...
				<div class="col-md-12">
					<div class="card card-primary">
						<div class="card-header">
              			...
              			<form id='frmcuisine_edit' name='frmcuisine_edit' method='post' enctype="multipart/form-data" autocomplete="off">
			                <div class="card-body">
			                	
			                	
			                	<div class="form-row">
			                  <div class="form-group col-md-9">
			                    <label for="exampleInputEmail1">Edit Cuisine Name</label>
			                    <input type="text" class="form-control" value="<?php echo $results[0]['cuisine_name'] ?>" name="cuisine_name" id="cuisine_name" placeholder="Edit Cuisine Name">	
			                  </div>
                  ...
                  <p class="mb-0"><i class="icon fas fa-ban"></i></p>
			                ...
			                <input type='hidden' name='cuisine_id' id='cuisine_id' value='<?php echo base64_encode($results[0]['id']) ?>'>
              			</form>	
