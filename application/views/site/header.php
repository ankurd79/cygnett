...
<link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@100;200;300;400;500;600;700;800;900&display=swap" rel="stylesheet">
		...
		<?php if(($class=='sitenav')&&($method=='leadership')) {?>
											...
											<nav class="collapse">
												<ul class="nav nav-pills" id="mainNav">
													...
													<li class="dropdown dropdown-mega">
														<a class="dropdown-item <?php if(($hnav['id']==1)||($hnav['id']==6)){?>dropdown-toggle<?php } ?>" href="<?php echo $url ?>" title="<?php echo $hnav['menu_name'] ?>">
															...
															<li>
																<div class="dropdown-mega-content our-story-megamenu">
																	...
																	?>		
  																		...
  																		<a href="<?php echo $purl ?>" title="<?php echo $n['menu_name'] ?>" class="tablinks" onmouseover="openCity(event, '<?php echo $menuname ?>')"><?php echo $n['menu_name'] ?></a>
  																		<?php } ?>
										...
										<div class="row content-grid-row" style="text-align: center;">
											<?php foreach($restaurantlist as $res){?>
    											<div class="content-grid-item col-lg-3 text-center">
    													<div class="p-3">
    														<a href="<?php echo urlgenerator('dining',$res['name'],$res['id']); ?>" title="Explore <?php echo $res['name'] ?> restaurant"><img class="img-fluid brand-logo" src="<?php echo base_url() ?>images/<?php echo folder_restaurant ?>/<?php echo $res['logo_image'] ?>" alt="<?php echo $res['name'] ?>" loading="lazy"></a>
    													</div>
    											</div>
											<?php }  ?>
