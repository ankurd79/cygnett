...
class Bedtypemgmt extends CI_Controller {

    	function __construct() {
    	parent::__construct();
    	$this->module='Bedtypes';
    	$this->load->model('api/'.strtolower($this->module).'/Bedtype_model');
	...
	public function edit(){
        ...
        $pdata=$this->Bedtype_model->getData($locId,'');
	...
	public function list(){
		...
		$data['results']=$this->Bedtype_model->getdata('',0);
