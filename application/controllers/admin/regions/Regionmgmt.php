...
class Regionmgmt extends CI_Controller {

    	function __construct() {
    	parent::__construct();
    	$this->module='Regions';
    	$this->load->model('api/'.strtolower($this->module).'/Region_model');
	...
	public function edit(){
        ...
        $pdata=$this->Region_model->getData($locId,'');
	...
	public function list(){
		...
		$data['results']=$this->Region_model->getdata('',0);
