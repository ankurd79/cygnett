...
class Departmentmgmt extends CI_Controller {

    	function __construct() {
    	parent::__construct();
    	$this->module='Departments';
    	$this->load->model('api/'.strtolower($this->module).'/Department_model');
	...
	public function edit(){
        ...
        $pdata=$this->Department_model->getData($locId,'');
	...
	public function list(){
		...
		$data['results']=$this->Department_model->getdata('',0);
